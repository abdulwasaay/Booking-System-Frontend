                        ...
                        ({
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className=' flex justify-between border-1 ml-[20px] mr-[20px] pl-[20px] mb-1 pr-[60px] pt-[10px] pb-[10px] rounded-lg max-[411px]:pr-[10px] max-[411px]:pl-[10px] max-[411px]:flex-col '>
                                    ...
                                    <input type='text' required name='name' value={values.name} onChange={handleChange} onBlur={handleBlur} placeholder='First and last name' className={` w-[1050px] h-[40px] ml-[20px] pl-[20px] rounded-lg outline-none max-[411px]:ml-[10px] max-[411px]:w-[94%] ${errors.name ? 'border-2 border-red-600' : 'border-none'}`} />
                                </div>
                                ...
                                <div className=' flex justify-between border-1 ml-[20px] mr-[20px] mb-1 pl-[20px] pr-[60px] pt-[10px] pb-[10px] rounded-lg max-[411px]:pr-[10px] max-[411px]:pl-[10px] max-[411px]:flex-col'>
                                    ...
                                    <input type='number' required name='phone' value={values.phone} onChange={handleChange} onBlur={handleBlur} placeholder='Eg. +92345 0000000' className={`number w-[1050px] h-[40px] ml-[20px] pl-[20px] rounded-lg outline-none max-[411px]:ml-[10px] max-[411px]:w-[94%] ${errors.phone ? 'border-2 border-red-600' : 'border-none'}`} />
                                </div>
                        ...
                        ({
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className=' flex justify-between border-1 ml-[20px] mr-[20px] pl-[20px] mb-1 pr-[60px] pt-[10px] pb-[10px] rounded-lg max-[411px]:pr-[10px] max-[411px]:pl-[10px] max-[411px]:flex-col '>
                                    ...
                                    <textarea required name='address' value={values.address} onChange={handleChange} onBlur={handleBlur} className={`w-[1050px] h-[60px] ml-[20px] pl-[20px] pr-[20px] pt-[10px] rounded-lg outline-none max-[411px]:ml-[10px] max-[411px]:w-[94%] resize-none ${errors.address ? 'border-2 border-red-600' : 'border-none'}`} />
                                </div>
                                <p className=' text-center text-red-600 font-extrabold ml-[20px] mr-[20px]'>
                                ...
                                <div className=' flex justify-between border-1 ml-[20px] mr-[20px] mb-1 pl-[20px] pr-[60px] pt-[10px] pb-[10px] rounded-lg max-[411px]:pr-[10px] max-[411px]:pl-[10px] max-[411px]:flex-col'>
                                    ...
                                    <input type='number' required name='postcode' value={values.postcode} onChange={handleChange} onBlur={handleBlur} className={`number w-[1050px] h-[40px] ml-[20px] pl-[20px] rounded-lg outline-none max-[411px]:ml-[10px] max-[411px]:w-[94%] ${errors.postcode ? 'border-2 border-red-600' : 'border-none'}`} />
                                </div>
                                <p className=' text-center text-red-600 font-extrabold ml-[20px] mr-[20px]'>
                                ...
                                <div className=' flex justify-between border-1 ml-[20px] mr-[20px] mb-1 pl-[20px] pr-[60px] pt-[10px] pb-[10px] rounded-lg max-[411px]:pr-[10px] max-[411px]:pl-[10px] max-[411px]:flex-col'>
                                    ...
                                    <input type='text' required name='country' value={values.country} onChange={handleChange} onBlur={handleBlur} className={`w-[1050px] h-[40px] ml-[20px] pl-[20px] rounded-lg outline-none max-[411px]:ml-[10px] max-[411px]:w-[94%] ${errors.country ? 'border-2 border-red-600' : 'border-none'}`} />
                                </div>
                                <p className=' text-center text-red-600 font-extrabold ml-[20px] mr-[20px]'>
                        ...
                        ({
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className='border-1 ml-[20px] mr-[20px] mb-1 pl-[20px] pr-[60px] rounded-lg pt-[10px]'>
                                    ...
                                    <div className='flex justify-between max-[521px]:flex-col'>
                                        <label className='flex'>
                                            <input type='radio' name='withdrawMethod' onChange={handleChange} onBlur={handleBlur} className={`mt-[-20px] ${errors.withdrawMethod ? 'border-2 border-red-600' : 'border-none'}`}/>
                                ...
                                <div className=' flex justify-between border-1 ml-[20px] mr-[20px] mb-1 pl-[20px] pr-[60px] pt-[10px] pb-[10px] rounded-lg max-[411px]:pr-[10px] max-[411px]:pl-[10px] max-[411px]:flex-col'>
                                    ...
                                    <input type='number' required name='cardNum' onChange={handleChange} onBlur={handleBlur} value={values.cardNum}  className={`number w-[1050px] h-[40px] ml-[20px] pl-[20px] rounded-lg outline-none max-[411px]:ml-[10px] max-[411px]:w-[94%] ${errors.cardNum ? 'border-2 border-red-600' : 'border-none'}`} />
                                </div>
                                <p className=' text-center text-red-600 font-extrabold ml-[20px] mr-[20px]'>
                                ...
                                <div className=' flex justify-between border-1 ml-[20px] mr-[20px] mb-1 pl-[20px] pr-[60px] pt-[10px] pb-[10px] rounded-lg max-[411px]:pr-[10px] max-[411px]:pl-[10px] max-[411px]:flex-col'>
                                    ...
                                    <input type='text' required name='securityCode' onChange={handleChange} onBlur={handleBlur} value={values.securityCode}  className={`w-[1050px] h-[40px] ml-[20px] pl-[20px] rounded-lg outline-none max-[411px]:ml-[10px] max-[411px]:w-[94%] ${errors.securityCode ? 'border-2 border-red-600' : 'border-none'}`} />
                                </div>
                                <p className=' text-center text-red-600 font-extrabold ml-[20px] mr-[20px]'>
                                ...
                                <div className=' flex justify-between border-1 ml-[20px] mr-[20px] mb-1 pl-[20px] pr-[60px] pt-[10px] pb-[10px] rounded-lg max-[411px]:pr-[10px] max-[411px]:pl-[10px] max-[411px]:flex-col'>
                                    <p className=' relative top-2 max-[411px]:left-5'>Phone</p>
                                    <input type='number' required name='phone' onChange={handleChange} onBlur={handleBlur} value={values.phone}  placeholder='Exact name as on the card' className={`number w-[1050px] h-[40px] ml-[20px] pl-[20px] rounded-lg outline-none max-[411px]:ml-[10px] max-[411px]:w-[94%] ${errors.phone ? 'border-2 border-red-600' : 'border-none'}`} />
                                </div>
                                <p className=' text-center text-red-600 font-extrabold ml-[20px] mr-[20px]'>
